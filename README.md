...
<table align="center" width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <td width="50%" valign="top">
      <h3>🚀 About Me</h3>
      <p>
        I am a dedicated <strong>Artificial Intelligence and Data Science</strong> student passionate about solving real-world problems through data, machine learning, and intelligent systems. I enjoy building projects that transform raw data into actionable insights and impactful solutions.
      </p>
      <ul>
        <li>🎓 Pursuing a Bachelor's degree in <strong>AI & Data Science</strong>.</li>
        <li>💡 Exploring <strong>Machine Learning, Deep Learning, NLP, and Data Analytics</strong>.</li>
        <li>🧠 Building AI-powered applications and analytical solutions.</li>
        <li>🎯 Aspiring to become a skilled <strong>Data Scientist & AI Engineer</strong>.</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>⚡ Quick Facts</h3>
      <ul>
        <li>🔭 Currently working on Data Science and Machine Learning projects.</li>
        <li>📊 Building interactive dashboards with <strong>Power BI</strong>.</li>
        <li>🐍 Strengthening skills in <strong>Python, SQL, C++, and Data Structures</strong>.</li>
        <li>💬 Ask me about Data Analytics, Power BI, Python, and Machine Learning.</li>
        <li>⚡ Fun Fact: I enjoy turning complex datasets into meaningful stories.</li>
      </ul>
    </td>
  </tr>
</table>
